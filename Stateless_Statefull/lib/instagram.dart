                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            _buildProfileStat("Followers", "1k"),
                            _buildProfileStat("Following", "5"),
                          ],
                        ),
                        SizedBox(height: 8),
                      ],
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(
            icon: CircleAvatar(
              radius: 12,
              backgroundImage: CachedNetworkImageProvider('https://picsum.photos/id/1/200/300'),
            ),
            label: '',
          ),
        ],
      ...
      child: Column(
        children: [
          CircleAvatar(
            ...
            backgroundImage: CachedNetworkImageProvider(
              'https://picsum.photos/id/${index + 73}/200/300', // Unique image URL for each story
            ),
          ),
          SizedBox(height: 4),
          Text(label),
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        return CachedNetworkImage(
          imageUrl: 'https://picsum.photos/id/${index + 75}/200/300',
          fit: BoxFit.cover,
        );
      },
    );
